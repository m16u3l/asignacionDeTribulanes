$(document).ready(function() {
  ...
  $('.table tbody').on('click', 'a.edit-row', function() {
    ...
    $('#formulario_actualizar_form input#id_proveedor_retenciones').val($(this).data("proveedor_retenciones"));
    ...
    // $('#formulario_actualizar_form select#id_tipo_documento').select2('disable').val($(this).data("tipo_documento")).trigger('change');
  ...
  // Validaciones
  $('input#id_ruc').mask("9999?9999999");
  ...
  $('input#id_telefono_1').mask("999999?999999");
  $('input#id_telefono_2').mask("999999?999999");
