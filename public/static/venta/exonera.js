$(document).ready(function() {
  ...
  $('#btn_agregar').on('click', function (evento) {
	...
	'add_detail': producto
	  ...
	  var exonera = document.createTextNode(val_total);
	  ...
	  var total_exonera = parseFloat($('#id_total_exonera').val()) + parseFloat(val_total);
	  ...
	  $('#id_total_exonera').val(total_exonera);
  ...
  $('.table tbody').on('click', 'a#eliminar',function () {
    ...
    exonera =  row.find("td").eq(6).html();

    var total_importe = parseFloat($('#id_total_importe').val()) - parseFloat(importe);
    var total_exonera = parseFloat($('#id_total_exonera').val()) - parseFloat(exonera);
