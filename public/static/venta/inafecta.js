$(document).ready(function() {
  ...
  $('#btn_agregar').on('click', function (evento) {
	...
	'add_detail': producto
	  ...
	  var inafecta = document.createTextNode(val_total);
	  ...
	  var td_inafecta =document.createElement("TD");
	  ...
	  tr.append(td_inafecta);
	  tr.append(td_button);

	  $('#tabla_detalle').append(tr);

	  var total_importe = parseFloat($('#id_total_importe').val()) + parseFloat(val_total);
	  var total_inafecta = parseFloat($('#id_total_inafecta').val()) + parseFloat(val_total);

	  // Round
	  total_importe = Math.round(total_importe *100) / 100;
	  total_inafecta = Math.round(total_inafecta *100) / 100;
	  
	  $('#id_total_importe').val(total_importe);
	  $('#id_total_inafecta').val(total_inafecta);
  ...
  $('.table tbody').on('click', 'a#eliminar',function () {
    ...
    inafecta =  row.find("td").eq(6).html();
    
    var total_importe = parseFloat($('#id_total_importe').val()) - parseFloat(importe);
    var total_inafecta = parseFloat($('#id_total_inafecta').val()) - parseFloat(inafecta);
