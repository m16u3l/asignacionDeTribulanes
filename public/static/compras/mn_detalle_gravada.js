$(document).ready(function() {
  ...
  $('#id_percepcion_ME').val(0);

  // hiden
  $('#id_ME_total_pagar').attr('type', 'hidden');
  $('#id_ME_total_no_gravada').attr('type', 'hidden');
  $('#id_ME_total_valor').attr('type', 'hidden');
  $('#id_ME_total_igv').attr('type', 'hidden');
  $('#id_ME_total_importe').attr('type', 'hidden');

  $('#id_percepcion_ME').attr('type', 'hidden');
  $('#id_tipo_cambio').attr('type', 'hidden');  
  ...
  $('#btn_agregar').on('click', function (evento) {
    ...
    $.ajax({
	  ...
	  var val_importe = val_parciales;
	  importe = Math.round(importe * 100) / 100;

	  var val_exonera = parseFloat($('#id_no_gravada').val());
	  ...
	  // td costo
	  var val_costo = (val_parciales * total_costo) / parseFloat($('#id_total_importe').val()) ;
