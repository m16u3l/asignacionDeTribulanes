$(document).ready(function() {
  ...
  $('.table tbody').on('click', 'a.edit-row', function() {
    ...
    $('#formulario_actualizar_modal input#id_distrito').val($(this).data("distrito"));
    $('#formulario_actualizar_modal input#id_region').val($(this).data("region"));
    $('#formulario_actualizar_modal input#id_provincia').val($(this).data("provincia"));
  });
  ...
  **/      
  ...
  $("input#id_provincia").addClass('uppercase');
  $("input#id_region").addClass('uppercase');
  $("input#id_distrito").addClass('uppercase');
  $('input#id_codigo').mask('999999');
});
