        ...
        <div class="offset-md-1 col-md-10">
          ...
          <div class="row">
            <div class="offset-md-4 col-md-6">
              <a id="boton_register_professional" href="#" class="btn btn-md btn-rounded btn-info" data-toggle="modal"
                 data-target="#register_professinal_modal"
              >NUEVO PROFESIONAL</a>
            </div>
          </div>
            ...
            <form class="navbar-form pull right" action="{{ route ('lista_profesionales')}}" method="GET" role="search">
              <div class="panel-body">
                <div class="input-group input-group">
                  <input type="text" class="form-control" name="name" placeholder="Nombre profesional.."
                ...
                <div class="card-header clearfix">
                  <div class="row">
                    ...
                    <div class="col-lg-1 col-12 text-center row-sm-center">
                      <a href="#" class="btn btn-rounded btn-success modal_update_professional" data-toggle="modal"
                         data-target="#update_professinal_modal"
                         ...
                         data-email="{{ $professional->contact->email or "Sin email"}}"
                         data-phone="{{ $professional->contact->phone or "0"}}"
                         data-address="{{ $professional->contact->address or "0"}}"
                         data-workload="{{ $professional->workload }}"
                         gta-degree_id="{{ $professional->degree_id }}"
