...
<div class="col">
  ...
  <h5 class="h5 text-center" for="fileProfessionals">IMPORTACION DE PROFESIONALES</h5>
  <div class="row">
    <div class="col-md-6">
      ...
      <img class="text-center img-fluid" src="/images/profesionales_ejemplo1.png" alt="" style="display: block; margin-left: auto; margin-right: auto;
          ">
      <img class="text-center img-fluid" src="/images/profesionales_ejemplo2.png" alt="" style="display: block; margin-left: auto; margin-right: auto;
          ">
      <img class="text-center img-fluid" src="/images/profesionales_ejemplo3.png" alt="" style="display: block; margin-left: auto; margin-right: auto;
          ">
    ...
    <div class="col-md-6">
      ...
      <ul class="list">
        ...
        <li class="list-item">La primera fila debe tener columnas cuyo contenido sea "NOMBRE", "APELLIDO PATERNO", "APELLIDO MATERNO", "CORREO",
          , "TITULO DOCENTE", "CARGA HORARIA", "NOMBRE CUENTA", "TELEFONO", "DIRECCION", "PERFIL", "CONTRASEÑA CUENTA", "CI",
          "CODIGO SIS" de izquierda a derecha en ese orden.
        </li>
